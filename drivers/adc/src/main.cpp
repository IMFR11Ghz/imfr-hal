...
void setup() {
  ...
  adc->setReference(
      ...
      ADC_0); // change all 3.3 to 1.2 if you change the reference to 1V2

  adc->setAveraging(16);  // set number of averages
  adc->setResolution(16); // set bits of resolution

  // it can be any of the ADC_CONVERSION_SPEED enum: VERY_LOW_SPEED, LOW_SPEED,
  // MED_SPEED, HIGH_SPEED_16BITS, HIGH_SPEED or VERY_HIGH_SPEED
...
void loopGraph() {
  ...
  else if ( timeCur > 296 ) Serial.println("fail");
}
